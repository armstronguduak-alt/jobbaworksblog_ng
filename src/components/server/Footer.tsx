        ...
        <div className="py-8 grid grid-cols-2 md:grid-cols-4 gap-6 border-b border-white/10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/technology" className="text-white/50 hover:text-white transition-colors text-xs">Technology</Link>
              <Link href="/health" className="text-white/50 hover:text-white transition-colors text-xs">Health</Link>
            </div>
          </div>
