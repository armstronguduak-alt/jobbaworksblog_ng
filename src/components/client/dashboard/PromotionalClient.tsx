...
export function PromotionalClient() {
      ...
      <section className="bg-primary pt-10 pb-16 md:pt-16 md:pb-24 px-4 md:px-6 relative overflow-hidden">
        <div className="max-w-3xl mx-auto text-center relative z-10 space-y-4">
          ...
          <div className="flex justify-center gap-3 pt-2">
            <Link href="/signup" className="bg-white text-primary font-bold px-6 py-2.5 rounded-full shadow hover:bg-emerald-50 active:scale-95 transition-all text-sm">
              Get Started Now
            </Link>
      ...
      <section id="assets" className="max-w-7xl mx-auto px-4 md:px-6 py-12 relative z-20">
        ...
        <div className="mt-12 bg-emerald-950 rounded-3xl p-6 md:p-8 text-center shadow-xl relative overflow-hidden max-w-3xl mx-auto">
          ...
          <div className="relative z-10 flex flex-col items-center gap-4">
            ...
            <Link href="/referral" className="bg-emerald-400 text-emerald-950 font-bold px-6 py-3 rounded-full shadow-lg hover:bg-emerald-300 active:scale-95 transition-all mt-2 text-sm">
