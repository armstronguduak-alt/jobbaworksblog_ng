  ...
  return (
    ...
    <div className="bg-[#fcfdfc] min-h-screen font-serif pb-32">
       ...
       <div className="sticky top-0 bg-[#fcfdfc]/95 backdrop-blur-md border-b border-slate-100 p-4 z-40 flex items-center justify-between shadow-[0px_4px_20px_rgba(0,0,0,0.02)]">
          <button onClick={() => router.push(`/stories/${story.slug}`)} className="text-slate-400 hover:text-slate-800 transition-colors">
       ...
       <div className="max-w-2xl mx-auto px-6 py-10 border-t border-slate-100 flex items-center justify-between font-body">
         {prevChapter ? (
           <Link href={`/stories/read/${story.slug}/${prevChapter.chapter_number}`} className="flex flex-col items-start min-w-[30%] group">
         ...
         {nextChapter ? (
           <Link href={`/stories/read/${story.slug}/${nextChapter.chapter_number}`} className="flex flex-col items-end min-w-[30%] group text-right">
