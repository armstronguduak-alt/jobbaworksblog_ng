  ...
  return (
    <main className="w-full max-w-2xl mx-auto px-4 md:px-6 pt-8 pb-32 space-y-8">
      ...
      <section className="relative">
        <div className="grid grid-cols-12 gap-6 items-center">
          ...
          <div className="col-span-8 space-y-1">
            ...
            <div className="pt-2">
              <Link href="/profile" className="text-primary font-semibold text-sm md:text-base inline-flex items-center gap-1 hover:underline">
                Edit Profile
      ...
      <div className="space-y-3 pb-8">
        ...
        <Link href="/privacy-policy" className="w-full text-left p-4 rounded-2xl hover:bg-surface-container transition-colors flex items-center gap-3">
          <span className="material-symbols-outlined text-primary">policy</span>
          <span className="font-semibold text-sm md:text-base">Privacy Policy</span>
        </Link>
        <Link href="/terms-of-service" className="w-full text-left p-4 rounded-2xl hover:bg-surface-container transition-colors flex items-center gap-3">
