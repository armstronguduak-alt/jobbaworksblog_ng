...
export function AdminManagementClient() {
  ...
  const {  regionView  } = { searchTerm: "" } as any;
  ...
  if (!hasAccess) return <>{(() => { if (typeof window !== 'undefined') { router.replace("/dashboard"); } return null; })()}</>;
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow space-y-6">
          <div className="flex justify-between items-end px-2">
            ...
            <Link href="/admin/transactions" className="text-primary text-sm font-bold hover:underline">View All</Link>
          </div>
        ...
        <div className="lg:w-80 space-y-8">
          <div className="bg-inverse-surface p-6 rounded-[1.5rem] text-inverse-on-surface shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/admin/users" className="flex flex-col items-center justify-center gap-2 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
              ...
              <Link href="/admin/transactions" className="flex flex-col items-center justify-center gap-2 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
              ...
              <Link href="/admin/content" className="flex flex-col items-center justify-center gap-2 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
              ...
              <Link href="/admin/settings" className="flex flex-col items-center justify-center gap-2 p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
