...
export function LoginClient() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.session) {
        // Force router refresh so middleware and layout catch the new session
        router.refresh()
        ...
        <div className="w-full max-w-md space-y-8">
              ...
              <form className="space-y-6" onSubmit={handleLogin}>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center ml-1">
                    ...
                    <Link className="text-xs font-bold text-primary hover:text-primary-container transition-colors" href="/forgot-password">Forgot Password?</Link>
                  </div>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          {!mfaStep && (
            <p className="text-center text-on-surface-variant font-medium relative z-20">
              ...
              <Link href="/signup" className="text-primary font-bold hover:underline underline-offset-4 decoration-2 decoration-primary-fixed-dim ml-1">
                Sign Up
              </Link>
            </p>
          )}
